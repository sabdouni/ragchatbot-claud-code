...
class TestRAGIntegration:
    ...
    def test_rag_system_initialization(self, mock_doc_proc, mock_vector_store, 
                                      mock_ai_gen, mock_session_mgr):
    ...
    @patch('rag_system.VectorStore')
    @patch('rag_system.DocumentProcessor')
    def test_query_without_session(self, mock_doc_proc, mock_vector_store, 
                                  mock_ai_gen, mock_session_mgr):
    ...
    @patch('rag_system.VectorStore')
    @patch('rag_system.DocumentProcessor')
    def test_query_with_session(self, mock_doc_proc, mock_vector_store, 
                               mock_ai_gen, mock_session_mgr):
    ...
    @patch('rag_system.VectorStore')
    @patch('rag_system.DocumentProcessor')
    def test_query_with_sources(self, mock_doc_proc, mock_vector_store, 
                               mock_ai_gen, mock_session_mgr):
    ...
    @patch('rag_system.VectorStore')
    @patch('rag_system.DocumentProcessor')
    def test_add_course_document_success(self, mock_doc_proc, mock_vector_store, 
                                        mock_ai_gen, mock_session_mgr, sample_course, 
        ...
        mock_doc_proc.return_value.process_course_document.assert_called_once_with("/path/to/course.txt")
        
        # Verify vector store operations
        mock_vector_store.return_value.add_course_metadata.assert_called_once_with(sample_course)
        mock_vector_store.return_value.add_course_content.assert_called_once_with(sample_course_chunks)
    
    @patch('rag_system.SessionManager')
    @patch('rag_system.AIGenerator')
    @patch('rag_system.VectorStore')
    @patch('rag_system.DocumentProcessor')
    def test_add_course_document_error(self, mock_doc_proc, mock_vector_store, 
                                      mock_ai_gen, mock_session_mgr):
        ...
        mock_doc_proc.return_value.process_course_document.side_effect = Exception("Parse error")
    ...
    @patch('os.listdir')
    def test_add_course_folder_success(self, mock_listdir, mock_isfile, mock_exists, 
                                      mock_doc_proc, mock_vector_store, mock_ai_gen, 
                                      mock_session_mgr, sample_course, sample_course_chunks):
    ...
    @patch('rag_system.VectorStore')
    @patch('rag_system.DocumentProcessor')
    def test_get_course_analytics(self, mock_doc_proc, mock_vector_store, 
                                 mock_ai_gen, mock_session_mgr):
    ...
    @patch('rag_system.VectorStore')
    @patch('rag_system.DocumentProcessor')
    def test_error_handling_in_query(self, mock_doc_proc, mock_vector_store, 
                                    mock_ai_gen, mock_session_mgr):
    ...
    @patch('rag_system.VectorStore')
    @patch('rag_system.DocumentProcessor')
    def test_tool_integration(self, mock_doc_proc, mock_vector_store, 
                             mock_ai_gen, mock_session_mgr):
